...
def main():
	...
	samples, species = get_data()
	scale(samples, species)


def scale(samples, species):
	''' Standardizes samples with scaling before clustering'''
...
def get_data():
	...
	data = np.array([[  242. ,    23.2,    25.4,    30. ,    38.4,    13.4],
